...
| `replayDblClick`         | Emitted when the replay viewport is double-clicked. Carries the current fullscreen state so listeners can react (e.g., toggle fullscreen) without a separate query. | `CustomEvent<ReplayDblClickDetail>`         |
